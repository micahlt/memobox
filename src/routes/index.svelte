...
<div class="template" transition:fade={{ delay: 10, duration: 300 }}>
	<nav>
		<img src="/assets/wordmark.svg" alt="Memobox logo" />
	</nav>
	<main>
		<div class="header">
		...
		<div class="about">
			<div class="about-inner">
				<div class="about-col">
					<h2>
						<i class="ri-timer-flash-fill" /><br />
						Passive inbox
					</h2>
					<p>
						A contact method that doesn't get in your way. Check your Box whenever you want, or
						don't.
					</p>
				</div>
				<div class="about-col">
					<h2>
						<i class="ri-money-dollar-box-fill" /><br />
						Completely free
					</h2>
					<p>
						All your messages go to a private repository with unlimited storage, powered by GitHub.
					</p>
				</div>
			</div>
		</div>
